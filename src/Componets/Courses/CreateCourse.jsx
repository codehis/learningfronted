...
import { createNewCourse } from "../../Store/Slices/CourseSlices";
  ...
  return (
    <div  className="flex items-center justify-center h-[100vh]">
       <form
          ...
          className="flex flex-col justify-center gap-5 rounded-lg p-4  w-[700px] h-[450px] my-10 shadow-[0_0_10px_black] relative"
        >
          <Link
        onClick={()=>navigate(-1)}

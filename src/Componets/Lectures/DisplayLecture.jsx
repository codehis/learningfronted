...
import {
  deleteCourseLecture,
  getCourseLecture,
} from "../../Store/Slices/LectureSlices";
...
const DisplayLecture = () => {
  ...
  return (
      ...
      <>
      <div className=" hidden md:flex flex-col gap-10 items-center justify-center  border-2   ">
        ...
        <div className="flex justify-center gap-10 w-full">
          ...
          <div className="space-y-5 w-[50rem] p-2 rounded-lg shadow-[0_0_10px_black]">
            <video
          ...
          <ul className="w-[23rem] p-2 rounded-lg shadow-[0_0_10px_black] space-y-4">
      ...
      <div className="flex flex-col gap-10 items-center justify-center  border-2 md:hidden   ">
        {/* displaying the course name */}
        ...
        <div className="flex justify-center flex-wrap  gap-10 w-full">
          ...
          {/* right section for displaying all the lectures of the course */}
          <ul className="w-[50rem] p-2 rounded-lg shadow-[0_0_10px_black] space-y-4">
            <li className="font-semibold text-xl text-yellow-500 flex items-center justify-between">
              <p>Lectures List</p>
              {role === "ADMIN" && (
                <button
